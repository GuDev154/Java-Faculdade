...
public class Main {
    public static void main(String[] args) {
        ...
        livrosGrafo.adicionarConexao(livro2,livro3);
        ...
        livrosGrafo.adicionarConexao(livro6,livro7);
        //Coleção Game Of thrones
        livrosGrafo.adicionarConexao(livro8,livro9);
        livrosGrafo.adicionarConexao(livro8,livro10);
        livrosGrafo.adicionarConexao(livro8,livro11);
        livrosGrafo.adicionarConexao(livro9,livro10);
        livrosGrafo.adicionarConexao(livro9,livro11);
